 ...
 * { FooterFragment.OnFragmentInteractionListener} interface
...
public class FooterFragment extends Fragment {
  ...
  //  private static final String ARG_PARAM2 = "param2";
   ...
   // private String mParam1;
    ...
    private FragmentFooterListener mListener;
...
*/
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof FragmentFooterListener) {
            mListener = (FragmentFooterListener) context;
        } else {
     ...
     */
    public interface FragmentFooterListener {
        void onHome();
        void onAccount();
        void onBook();
    }
